...
public class MainMenu extends JFrame {
	 ...
	 */
	public MainMenu() {
		setTitle("Form Penilaian Siswa Institut Bisnis Informatika Kesatuan");
		...
		table_2.setModel(new DefaultTableModel(
			new Object[][] {
				...
				{"212310020", "MUHAMAD SUBHAN RIZKI AFIAT", "A"},
			},
			new String[] {
				"NPM", "Nama", "Nilai"
			}
		...
		rdbtnNewRadioButton.setBounds(70, 377, 35, 20);
		getContentPane().add(rdbtnNewRadioButton);
		
		JRadioButton rdbtnB = new JRadioButton("B");
		rdbtnB.setBounds(110, 377, 35, 20);
		getContentPane().add(rdbtnB);
		
		JRadioButton rdbtnC = new JRadioButton("C");
		rdbtnC.setBounds(150, 377, 35, 20);
		getContentPane().add(rdbtnC);
		
		JRadioButton rdbtnD = new JRadioButton("D");
		rdbtnD.setBounds(190, 377, 35, 20);
		getContentPane().add(rdbtnD);
		
		JRadioButton rdbtnE = new JRadioButton("E");
		rdbtnE.setBounds(230, 377, 35, 20);
